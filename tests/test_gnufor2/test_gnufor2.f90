...
!***********************************************************************************
    ...
    real(kind=4):: x1(N1), x2(N2), x3(N3), x4(N4)
    real(kind=4):: f1(N1), f2(N2), f3(N3), f4(N4)
    real(kind=4):: u1(1000), u2(1000), u3(1000), t(1000)
    real(kind=4):: xx(Nx), yy(Ny), zz(Nx,Ny), xyz(3,Nx,Ny), u(Nx), v(Nx)
    ...
    call gnufor_image(z_fractal,palette='gray',pause=-1.0,persist='no')
    ! ***********************************************************************************
    print *,'********************************************************************'
    ...
    call gnufor_image(x_fractal,y_fractal,z_fractal,pause=-1.0,persist='no')
    ! ***********************************************************************************
    print *,'********************************************************************'
    print *,'Example 32: RGB image plot'
    print *,'call gnufor_image(rgb,pause=-1.0,persist=''no'')'
    call gnufor_image(rgb,pause=-1.0,persist='no')
    ! ***********************************************************************************
    print *,'********************************************************************'
    print *,'Example 33: RGB image plot with specified x and y axes'
    print *,'call  image(x_fractal,y_fractal,rgb,pause=-1.0,persist=''no'')'
    call gnufor_image(x_fractal,y_fractal,rgb,pause=-1.0,persist='no')
    !***********************************************************************************
    !***********************************************************************************
    !***********************************************************************************
